...
export default class Games extends Interface {
     ...
     * @public @sealed
     */
    async getWindow(gameId, startingAt) {
     ...
     * @public @sealed
     */
    async getDetails(gameId, startingAt, participantIdsOrIds) {
        return this._get(this._baseURLs.feed, "/details/{gameId}", {
            query: {
                participantIds: participantIdsOrIds
                    ...
                    : undefined,
                startingTime: typeof startingAt === "string"
                    ? startingAt
                    : startingAt.toISOString(),
            },
            path: {
