 ...
 * @internal
 */
export declare function parseValueOrValuesAsArray<T>(valueOrValues: T | T[]): T[];
/**
 ...
 * @internal
 */
export declare function parseParameterizedEndpointPath(endpoint: string, pathParams: Record<string, unknown>): string;
