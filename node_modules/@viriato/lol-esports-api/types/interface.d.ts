 ...
 * @internal
 */
export type APIResponse<T extends keyof APIEndpoints> = APIOperations<T>["responses"][200]["content"]["application/json"];
/**
 ...
 * @internal
 */
export type APIOperations<T extends keyof APIEndpoints> = APIEndpoints[T]["get"];
/**
 ...
 * @internal
 */
export type APIEndpointParameters<T extends keyof APIEndpoints> = APIOperations<T> extends {
    parameters: {
        query?: Record<string, unknown>;
        path?: Record<string, unknown>;
    };
} ? APIOperations<T>["parameters"] : never;
/**
 ...
 * @internal
 */
export type APILocale = "en-US" | "en-GB" | "en-AU" | "cs-CZ" | "de-DE" | "el-GR" | "es-ES" | "es-MX" | "fr-FR" | "hu-HU" | "it-IT" | "pl-PL" | "pt-BR" | "ro-RO" | "ru-RU" | "tr-TR" | "ja-JP" | "ko-KR";
/**
...
export default abstract class Interface {
     ...
     * @internal @sealed
     */
    protected _get<T extends keyof APIEndpoints>(baseURLs: readonly string[], endpoint: T, params: APIEndpointParameters<T>): Promise<APIResponse<T>>;
}
